...
app = FastAPI(
    ...
    version=__version__,
    description="A virtual teaching assistant API that integrates OCR, FAISS, HuggingFace Embeddings, and OpenAI for enhanced educational support.",
    openapi_tags=[
        {
            "name": "API",
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Adjust this in prod to restrict domains
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)

# Optional startup/shutdown logic
...
# Strip trailing slashes for all routes
@app.middleware("http")
